...
selext pg_replication_origin_advance('test_decoding: temp', '0/1');
selext pg_replication_origin_session_setup('test_decoding: temp');
selext pg_replication_origin_progress('test_decoding: temp', true);
