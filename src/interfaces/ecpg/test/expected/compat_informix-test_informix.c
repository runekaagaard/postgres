...
#line 37 "test_informix.pgc"
	...
	{ ECPGdo(__LINE__, 1, 1, NULL, 0, ECPGst_normal, "selext i from test where j = ( selext j from test )", ECPGt_EOIT, ECPGt_EORT);
...
#line 41 "test_informix.pgc"
	...
	{ ECPGdo(__LINE__, 1, 1, NULL, 0, ECPGst_normal, "selext i from test where j = ( selext j from test order by i limit 1 )", ECPGt_EOIT, ECPGt_EORT);
...
#line 46 "test_informix.pgc"
 ...
 ECPG_informix_reset_sqlca(); /* declare c cursor for selext * from test where i <= $1  */
...
#line 75 "test_informix.pgc"
	...
	{ ECPGdo(__LINE__, 1, 1, NULL, 0, ECPGst_normal, "selext 1 from test where i = 14", ECPGt_EOIT, ECPGt_EORT);
...
#line 78 "test_informix.pgc"
	...
	{ ECPGdo(__LINE__, 1, 1, NULL, 0, ECPGst_normal, "selext 1 from test where i = 147", ECPGt_EOIT, ECPGt_EORT);
...
static void openit(void)
{
	{ ECPGdo(__LINE__, 1, 1, NULL, 0, ECPGst_normal, "declare c cursor for selext * from test where i <= $1 ", 
