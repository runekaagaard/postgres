...
#line 13 "strings.pgc"
  ...
  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "selext 'abcdef' , N'abcdef' as foo , E'abc\\bdef' as \"foo\" , U&'d\\0061t\\0061' as U&\"foo\" , U&'d!+000061t!+000061' uescape '!' , $foo$abc$def$foo$", ECPGt_EOIT, 
