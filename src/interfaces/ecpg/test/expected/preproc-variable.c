...
/* declare cur cursor for selext name , born , age , married , children from family */
...
#line 60 "variable.pgc"
	...
	strcpy(msg, "open");
	{ ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "declare cur cursor for selext name , born , age , married , children from family", ECPGt_EOIT, ECPGt_EORT);
