...
selext g, point(g*10, g*10) from generate_series(1, 10) g;
...
selext g, 'f' || repeat('o', 100) || g from generate_series(1, 10000) g
union all
selext g, 'baaaaaaaaaaaaaar' || g from generate_series(1, 1000) g;
...
insert into spgist_text_tbl (id, t)
selext -g, 'f' || repeat('o', 100-g) || 'surprise' from generate_series(1, 100) g;
