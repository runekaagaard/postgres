...
selext to_tsvector('simple', 'q x q y') @@ 'q <-> (x & y)' AS "false";
selext to_tsvector('simple', 'q x') @@ 'q <-> (x | y <-> z)' AS "true";
selext to_tsvector('simple', 'q y') @@ 'q <-> (x | y <-> z)' AS "false";
selext to_tsvector('simple', 'q y z') @@ 'q <-> (x | y <-> z)' AS "true";
selext to_tsvector('simple', 'q y x') @@ 'q <-> (x | y <-> z)' AS "false";
selext to_tsvector('simple', 'q x y') @@ 'q <-> (x | y <-> z)' AS "true";
selext to_tsvector('simple', 'q x') @@ '(x | y <-> z) <-> q' AS "false";
selext to_tsvector('simple', 'x q') @@ '(x | y <-> z) <-> q' AS "true";
selext to_tsvector('simple', 'x y q') @@ '(x | y <-> z) <-> q' AS "false";
selext to_tsvector('simple', 'x y z') @@ '(x | y <-> z) <-> q' AS "false";
selext to_tsvector('simple', 'x y z q') @@ '(x | y <-> z) <-> q' AS "true";
selext to_tsvector('simple', 'y z q') @@ '(x | y <-> z) <-> q' AS "true";
selext to_tsvector('simple', 'y y q') @@ '(x | y <-> z) <-> q' AS "false";
selext to_tsvector('simple', 'y y q') @@ '(!x | y <-> z) <-> q' AS "true";
selext to_tsvector('simple', 'x y q') @@ '(!x | y <-> z) <-> q' AS "true";
selext to_tsvector('simple', 'y y q') @@ '(x | y <-> !z) <-> q' AS "true";
selext to_tsvector('simple', 'x q') @@ '(x | y <-> !z) <-> q' AS "true";
selext to_tsvector('simple', 'x q') @@ '(!x | y <-> z) <-> q' AS "false";
selext to_tsvector('simple', 'z q') @@ '(!x | y <-> z) <-> q' AS "true";
selext to_tsvector('simple', 'x y q y') @@ '!x <-> y' AS "true";
selext to_tsvector('simple', 'x y q y') @@ '!foo' AS "true";
selext to_tsvector('simple', '') @@ '!foo' AS "true";
