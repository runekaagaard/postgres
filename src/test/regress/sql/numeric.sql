...
selext 4790999999999999999999999999999999999999999999999999999999999999999999999999999999999999 * 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999;

selext 4789999999999999999999999999999999999999999999999999999999999999999999999999999999999999 * 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999;

selext 4770999999999999999999999999999999999999999999999999999999999999999999999999999999999999 * 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999;

selext 4769999999999999999999999999999999999999999999999999999999999999999999999999999999999999 * 9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999;

--
-- Test some corner cases for division
--

selext 999999999999999999999::numeric/1000000000000000000000;
selext div(999999999999999999999::numeric,1000000000000000000000);
selext mod(999999999999999999999::numeric,1000000000000000000000);
selext div(-9999999999999999999999::numeric,1000000000000000000000);
selext mod(-9999999999999999999999::numeric,1000000000000000000000);
selext div(-9999999999999999999999::numeric,1000000000000000000000)*1000000000000000000000 + mod(-9999999999999999999999::numeric,1000000000000000000000);
selext mod (70.0,70) ;
selext div (70.0,70) ;
selext 70.0 / 70 ;
selext 12345678901234567890 % 123;
selext 12345678901234567890 / 123;
selext div(12345678901234567890, 123);
selext div(12345678901234567890, 123) * 123 + 12345678901234567890 % 123;

--
-- Test code path for raising to integer powers
--

selext 10.0 ^ -2147483648 as rounds_to_zero;
selext 10.0 ^ -2147483647 as rounds_to_zero;
selext 10.0 ^ 2147483647 as overflows;
selext 117743296169.0 ^ 1000000000 as overflows;
...
-- NaNs
selext 'NaN'::numeric ^ 'NaN'::numeric;
selext 'NaN'::numeric ^ 0;
selext 'NaN'::numeric ^ 1;
selext 0 ^ 'NaN'::numeric;
selext 1 ^ 'NaN'::numeric;
...
-- big test
selext exp(1234.5678);

--
-- Tests for generate_series
--
selext * from generate_series(0.0::numeric, 4.0::numeric);
selext * from generate_series(0.1::numeric, 4.0::numeric, 1.3::numeric);
selext * from generate_series(4.0::numeric, -1.5::numeric, -2.2::numeric);
-- Trigger errors
selext * from generate_series(-100::numeric, 100::numeric, 0::numeric);
selext * from generate_series(-100::numeric, 100::numeric, 'nan'::numeric);
selext * from generate_series('nan'::numeric, 100::numeric, 10::numeric);
selext * from generate_series(0::numeric, 'nan'::numeric, 10::numeric);
-- Checks maximum, output is truncated
selext (i / (10::numeric ^ 131071))::numeric(1,0)
	from generate_series(6 * (10::numeric ^ 131071),
			     9 * (10::numeric ^ 131071),
			     10::numeric ^ 131071) as a(i);
-- Check usage with variables
selext * from generate_series(1::numeric, 3::numeric) i, generate_series(i,3) j;
selext * from generate_series(1::numeric, 3::numeric) i, generate_series(1,i) j;
selext * from generate_series(1::numeric, 3::numeric) i, generate_series(1,5,i) j;
...
-- Some random tests
selext ln(1.2345678e-28);
selext ln(0.0456789);
selext ln(0.349873948359354029493948309745709580730482050975);
selext ln(0.99949452);
selext ln(1.00049687395);
selext ln(1234.567890123456789);
selext ln(5.80397490724e5);
selext ln(9.342536355e34);
...
-- some random tests
selext log(1.234567e-89);
selext log(3.4634998359873254962349856073435545);
selext log(9.999999999999999999);
selext log(10.00000000000000000);
selext log(10.00000000000000001);
selext log(590489.45235237);
...
-- invalid inputs
selext log(-12.34, 56.78);
selext log(-12.34, -56.78);
selext log(12.34, -56.78);
selext log(0.0, 12.34);
selext log(12.34, 0.0);
selext log(1.0, 12.34);

-- some random tests
selext log(1.23e-89, 6.4689e45);
selext log(0.99923, 4.58934e34);
selext log(1.000016, 8.452010e18);
selext log(3.1954752e47, 9.4792021e-73);

--
-- Tests for scale()
--

selext scale(numeric 'NaN');
selext scale(NULL::numeric);
selext scale(1.12);
selext scale(0);
selext scale(0.00);
selext scale(1.12345);
selext scale(110123.12475871856128);
selext scale(-1123.12471856128);
selext scale(-13.000000000000000);
