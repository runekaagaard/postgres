...
step "selexti" { EXECUTE getrow_idx; }
step "selexts" { EXECUTE getrow_seq; }
step "end" { COMMIT; }

session "s2"
setup { BEGIN; }
step "selext2" { SELECT * FROM test_dc WHERE data=34 ORDER BY id,data; }
...
permutation "noseq" "chkiso" "prepi" "preps" "begin" "explaini" "explains" "selext2" "drop" "insert2" "end2" "selexti" "selexts" "end"
